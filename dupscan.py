...
SHINGLE = 3
_NEAR = float(sys.argv[3]) if len(sys.argv) > 3 else 0.75
_A_TAG = sys.argv[1] if len(sys.argv) > 1 else "dabi_2025"
_B_TAG = sys.argv[2] if len(sys.argv) > 2 else "progoti"
